          ...
          <div className="text-center">
            <div className="flex gap-md mb-lg justify-center">
              ...
              <div className="flex-col justify-center text-left gap-sm">
                <div><span className="badge badge-sakura mr-xs">Ý Nghĩa</span> <strong>{selectedKanji.meaning}</strong></div>
                {selectedKanji.on && <div><span className="badge badge-blue mr-xs">Onyomi</span> <span className="jp text-lg">{selectedKanji.on}</span></div>}
                {selectedKanji.kun && <div><span className="badge badge-green mr-xs">Kunyomi</span> <span className="jp text-lg">{selectedKanji.kun}</span></div>}
              </div>
            </div>
            ...
            <div className="text-left bg-sakura-50 p-md rounded-md mb-lg">
              ...
              <ul className="pl-md m-0" style={{lineHeight: 1.8}}>
                {selectedKanji.examples.map((ex, i) => {
                  ...
                  return (
                    <li key={i}>
                      <span className="jp font-medium">{jp}</span> : <span className="text-muted">{vn}</span>
                    </li>
                  );
                })}
              </ul>
