const CONJUGATION_RULES = [
  {
    ...
    group1: [
      ...
      {
        ending: "く",
        change: "いて / いた (Ngoại lệ: 行く → 行って / 行った)",
      },
  ...
  },
  {
    ...
    group1: [
      {
        ending: "Cột U (う, く, す...)",
        change: "Chuyển sang Cột A (あ, か, さ...) + ない",
      },
      {
        ending: "Lưu ý đuôi う",
        change: "う → わ + ない (Ví dụ: 買う → 買わない)",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Diễn tả khả năng làm được việc gì đó (Có thể...). Trợ từ を thường đổi thành が.",
    group1: [
      {
        ending: "Cột U (う, く, す...)",
        change: "Chuyển sang Cột E (え, け, せ...) + る",
      },
  ...
  },
  {
    ...
    description:
      "Bị / Được ai đó làm gì. Chủ thể bị tác động đi với が/は, người tác động đi với に.",
    group1: [
      {
        ending: "Cột U (う, く, す...)",
        change: "Chuyển sang Cột A (あ, か, さ...) + れる",
      },
  ...
  },
  {
    ...
    group1: [
      {
        ending: "Cột U (う, く, す...)",
        change: "Chuyển sang Cột A (あ, か, さ...) + せる",
      },
  ...
  },
  {
    ...
    group1: [
      {
        ending: "Cột U",
        change: "Chuyển sang Cột E + ば (Ví dụ: 行く → 行けば)",
      },
    ],
  ...
  },
  {
    ...
    group1: [
      {
        ending: "Cột U",
        change: "Chuyển sang Cột O + う (Ví dụ: 行く → 行こう)",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Ra lệnh, sai bảo (Làm đi!). Thường dùng trong quân đội, cổ vũ, hoặc người lớn tuổi nói với người nhỏ.",
    group1: [
